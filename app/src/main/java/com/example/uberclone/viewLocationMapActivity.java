    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRide.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Toast.makeText(viewLocationMapActivity.this, getIntent().getStringExtra("rUsername"),Toast.LENGTH_LONG).show();
                            ...
                            for(ParseObject uberRequest:objects){
                                ...
                                uberRequest.saveInBackground(new SaveCallback() {
                                    ...
                                    public void done(ParseException e) {
                                        if(e==null){
                                            Intent googleIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://maps.google.com/maps?saddr=" +getIntent().getDoubleExtra("dLatitude",0) +
